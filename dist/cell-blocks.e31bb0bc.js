...
exports.maxCol = exports.maxRow = exports.BOX_WIDTH = exports.CANVAS_HEIGHT = exports.CANVAS_WIDTH = void 0;
...
var Cell = /*#__PURE__*/function () {
  function Cell(r, c) {
    ...
    [r, c + 1], [r + 1, c - 1], [r + 1, c], [r + 1, c + 1]].filter(function (_ref) {
      ...
      return i >= 0 && j >= 0 && i < _constants.maxRow && j < _constants.maxCol;
    });
    this.nextState = null;
  }
...
var drawGrid = function drawGrid() {
  ...
  for (var i = 0; i < _constants.maxRow; i++) {
    gridBoxes[i] = [];

    for (var j = 0; j < _constants.maxCol; j++) {
      gridBoxes[i][j] = new _Cell.default(i, j);
      ctx.beginPath();
      ctx.rect(j * _constants.BOX_WIDTH, i * _constants.BOX_WIDTH, _constants.BOX_WIDTH, _constants.BOX_WIDTH);
      ctx.stroke();
    }
  }
...
var updateNeighborsLivingNeighbors = function updateNeighborsLivingNeighbors(cell) {
  ...
  cell.neighbors.forEach(function (_ref) {
    ...
    gridBoxes[i][j].livingNeighbors += updateVal;
  });
};

var toggleLife = function toggleLife(i, j) {
  var thisCell = gridBoxes[i][j];
  ctx.beginPath();
  thisCell.living = !thisCell.living;
  updateNeighborsLivingNeighbors(thisCell);
  ctx.fillStyle = getFillColor(thisCell);
  ctx.fillRect(j * _constants.BOX_WIDTH + 1, i * _constants.BOX_WIDTH + 1, _constants.BOX_WIDTH - 2, _constants.BOX_WIDTH - 2);
  ctx.stroke();
  ...
  gridBoxes.forEach(function (row, rowID) {
    row.forEach(function (thisCell, colID) {
      ...
      if (stateFlip) {
        ...
        ctx.beginPath();
        ctx.fillStyle = getFillColor(thisCell);
        ctx.fillRect(colID * _constants.BOX_WIDTH + 1, rowID * _constants.BOX_WIDTH + 1, _constants.BOX_WIDTH - 2, _constants.BOX_WIDTH - 2);
        ctx.stroke();
      }
    });
  });
...
var getRowColID = function getRowColID(e) {
  var rowID = Math.floor(e.offsetY / _constants.BOX_WIDTH);
  var colID = Math.floor(e.offsetX / _constants.BOX_WIDTH);
  return [rowID, colID];
};

var getFillColor = function getFillColor(thisCell) {
  return thisCell.living ? '#770000' : 'white';
}; // event handlers


var moveListener = function moveListener(e) {
  var _getRowColID = getRowColID(e),
...
var clickListener = function clickListener(e) {
  var _getRowColID3 = getRowColID(e),
...
startButton.addEventListener('click', startListener); // when browser loads script

drawGrid();
},{"./constants.js":"constants.js","./Cell":"Cell.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/cell-blocks.e31bb0bc.js.map